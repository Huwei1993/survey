...
<body>
	...
	<div class="header">
		<div class="dl-title">
			<span class="">调查问卷</span>
		</div>
		<div class="dl-log">
			欢迎您，<span class="dl-log-user">XXX</span> <a href="###" title="退出系统"
				class="dl-log-quit">[退出]</a> <a href="login.jsp" title="登录"
				class="dl-log-quit">退出登录</a>
			...
			var config = [ { /*首页展示*/
				...
				menu : [ {
					...
					items : [ {
						id : 'index',
						text : '问卷列表',
						href : 'survey_list.jsp',
						closeable : true
					}, {
						id : 'index2',
						text : '添加问卷',
						href : 'add_survey_list.jsp',
						closeable : true
					}, {
						id : 'index3',
						text : '问题列表',
						href : 'question_list.jsp',
						closeable : true
					}, {
						id : 'index4',
						text : '添加问题',
						href : 'add_question.jsp',
						closeable : true
					},
					...
					items : [ {
						id : 'index-1-1',
						text : '模板列表',
						href : 'module_list.jsp'
					}, {
						id : 'index-1-2',
						text : '添加模板',
						href : 'add_module_list.jsp'
					} ]
				}, {
					text : '统计管理',
					// 三级菜单集合
					...
					items : [ {
						id : 'index-3-1',
						text : '用户管理',
						href : 'user_manager.jsp'
					}, {
						id : 'index-3-2',
						text : '类别管理',
						href : 'class_manager.jsp'
					}, {
						id : 'index-3-3',
						text : '修改密码',
